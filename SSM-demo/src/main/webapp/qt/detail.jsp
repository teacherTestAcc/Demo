...
<li>
<a href="" title="">
<img src="${ld.mainPic }" width="400" height="250" />
</a>
</li>
<li class="pics"><a href="${ld.picOne }" class="zoom" title="凤凰古城" ><img src="images/jdcks1.jpg" width="100" height="63" /></a></li>
<li class="pics"><a href="${ld.picTwo }" class="zoom" title="凤凰古城"><img src="images/jdcks2.jpg" width="100" height="63" /></a></li>
<li class="pics"><a href="${ld.picThree }" class="zoom" title="凤凰古城"><img src="images/jdcks3.jpg" width="100" height="63" /></a></li>
</div>
<div class="jin2-right">
<ul>
<li>途乐行价：<span class="colorc">￥${ld.teamPrice+ld.maxYh }</span></li>
<li>团购价：<strong>￥${ld.teamPrice }</strong> 起</li>
<li>最大优惠：￥${ld.maxYh }</li>
<li>出游天数：${ld.days }天</li>
<li>出游人数：已有<span>0</span>人出游此线路</li>
<li>提前报名：建议提前一天报名</li>
<li><a href="addCart?id=${ld.lineId }"><img src="images/jgwc.jpg" width="122" height="42" /></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="order.html"><img src="images/js.jpg" width="123" height="43" /></a></li>
</ul>
</div>
</div>
<div class="tuijian">
