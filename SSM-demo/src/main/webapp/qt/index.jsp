...
<div id="menu">
  <div id="menu-m">
    <ul>
      ...
      <li><a href="getCart"><img src="images/che.jpg" width="176" height="42" /></a></li>
    </ul>
  </div>
</div>
<!--广告位图片-->
...
<div id="content1"> 
  ...
  <div id="con1-left">
    ...
    <div class="cs">
      <ul>
        <li><a href="getLine?name=凤凰古城">凤凰古城</a></li>
        <c:forEach var="l"  items="${jn}"> 
        	<li><a href="getLine?name=${l.linename }>${l.linename }</a></li>
        </c:forEach>
      </ul>
    </div>
